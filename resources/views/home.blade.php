                ...
                <article
                    ...
                    @if ($featured->cover_image)
                        <div class="aspect-[16/9] overflow-hidden">
                            <img alt="{{ $featured->title }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-ui-label text-ui-label font-bold text-on-surface">
                                        <a href="{{ route('users.profile', $featured->user->username) }}" class="hover:underline">{{ $featured->user->name }}</a>
                                    </p>
                            ...
                            <div class="flex items-center justify-between pt-2">
                                <div class="flex items-center gap-3">
                                    <p class="font-ui-label text-ui-label text-on-surface font-medium">
                                        <a href="{{ route('users.profile', $post->user->username) }}" class="hover:underline">{{ $post->user->name }}</a>
                                    </p>
